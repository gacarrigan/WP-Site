...
class WooDojo_HTML_Term_Description {
	...
	public function __construct () {
		...
		/* Class Settings */
		$this->token = 'woodojo-html-term-description';
	...
	public function render_field_edit ( $tag, $taxonomy ) {
		...
		<tr>
			...
			<span class="description"><?php _e( 'The description is not prominent by default, however some themes may show it.', 'woodojo-html-term-description' ); ?></span></td>
	...
	public function render_field_add ( $taxonomy ) {
		...
		?>
		<div>
			<label for="tag-description"><?php _ex( 'Description', 'Taxonomy Description', 'woodojo-html-term-description' ); ?></label>
			<?php wp_editor( '', 'html-tag-description', $settings ); ?>
			<p class="description"><?php _e( 'The description is not prominent by default, however some themes may show it.', 'woodojo-html-term-description' ); ?></p>
			<script type="text/javascript">
				// Remove the non-html field
