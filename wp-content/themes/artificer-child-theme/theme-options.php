...
// General
		...
		$options[] = array( 'name' => __( 'General Typography', 'woothemes' ) ,
			...
			'std' => array( 'size' => '1', 'unit' => 'em', 'face' => 'FontSiteSans-Roman', 'style' => '', 'color' => '#3E3E3E' ),
			'type' => 'typography' );
		...
		$options[] = array( 'name' => __( 'Widget Titles', 'woothemes' ) ,
			...
			'std' => array( 'size' => '.857', 'unit' => 'em', 'face' => 'FontSiteSans-Cond', 'style' => 'bold', 'color' => '#3E3E3E' ),
			'type' => 'typography' );
		...
		$options[] = array( "name" => "Display Tweet",
					"desc" => "Display the latest tweet from your Twitter account (Twitter ID specified in Contact tab)",
